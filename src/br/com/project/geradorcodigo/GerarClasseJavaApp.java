...
public class GerarClasseJavaApp extends JFrame implements ActionListener,
	...
	@CheckBoxGeraCodigoAnnotation(descricao = "Interface Servi�o")
	...
	@CheckBoxGeraCodigoAnnotation(descricao = "Servi�o Implementa��o")
	...
	@CheckBoxGeraCodigoAnnotation(descricao = "Dao Implementa��o")
	...
	private void montarTela() {
		...
		panelAcao.setBorder(new TitledBorder("A��es"));
	...
	private boolean validar() {
		...
		if (resultado.isEmpty()) {
			JOptionPane.showMessageDialog(this,
					"Selecione as classes para gera��o.");
			return false;
		}
	...
	private void gerarDeclaracaoBean() {
		...
		builder.append("<bean id=\""
				+ textFieldNomeClasse.getText().toLowerCase()
				+ "Controller\" name=\""
				+ textFieldNomeClasse.getText().toLowerCase()
				+ "Controller\"  class=\"br.com.project.geral.controller."
				+ textFieldNomeClasse.getText() + "Controller\" />\n");
		builder.append("<bean id=\"repository" + textFieldNomeClasse.getText()
				+ "\" name=\"repository" + textFieldNomeClasse.getText()
				+ "\"  class=\"br.com.dao.implementacao.Dao"
				+ textFieldNomeClasse.getText() + "\" />\n");
		builder.append("<bean id=\"srv" + textFieldNomeClasse.getText()
				+ "\" name=\"srv" + textFieldNomeClasse.getText()
				+ "\"  class=\"br.com.srv.implementacao.Srv"
				+ textFieldNomeClasse.getText() + "Impl\" />\n");

		builder.append("\n\n\n");
		builder.append("Hibernate: \n\n");
		builder.append("<mapping class=\"br.com.project.model.classes."
				+ textFieldNomeClasse.getText() + "\" />");
	...
	private void verificaExisteArquivoJava(File filepathController)
		...
		if (!filepathController.exists()) {
			...
			JOptionPane.showMessageDialog(this, "J� existe "
